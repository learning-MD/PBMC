...
pbmc <- readRDS("PBMC_CellRanger_6.1.2/Upload/cd4_subclusters_1.12.23.rds")
...
pbmc <- readRDS("PBMC_CellRanger_6.1.2/Upload/cd8_subclusters_1.12.23.rds")
pbmc@meta.data$cluster_name <- Idents(pbmc)
...
pbmc <- readRDS("PBMC_CellRanger_6.1.2/Upload/NK_subclusters_1.12.23.rds")
pbmc@meta.data$cluster_name <- Idents(pbmc)
