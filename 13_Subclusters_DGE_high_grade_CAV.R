...
for (csv_file in csv_files) {
  ...
  counts <- counts %>% select(gene, metadata$Sample_ID)
  ...
  # Save new csv file
  write_csv(df, paste0("PBMC_CellRanger_6.1.2/Upload/Subclusters_DGE/CD8/High_grade/", file_name, ".csv"))
}
...
for (csv_file in csv_files) {
  ...
  # Save new csv file
  write_csv(df, paste0("PBMC_CellRanger_6.1.2/Upload/Subclusters_DGE/NK_cells/High_grade/", file_name, ".csv"))
}
...
for (csv_file in csv_files) {
  ...
  # Save new csv file
  write_csv(df, paste0("PBMC_CellRanger_6.1.2/Upload/Subclusters_DGE/CD4/High_grade/", file_name, ".csv"))
}
